<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Administrator.master" AutoEventWireup="true" CodeBehind="Messages.aspx.cs" Inherits="LevelsPro.AdminPanel.Messages" %>
<%@ Register TagPrefix="uc" TagName="Profile" Src="~/PlayerPanel/UserControls/uc_Profile.ascx" %>
<%@ Register TagPrefix="uc" TagName="MessageDetails" Src="~/AdminPanel/UserControls/uc_MessageDetails.ascx" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register TagPrefix="uc" TagName="ucComposeMessage" Src="~/AdminPanel/UserControls/uc_ComposeMessage.ascx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
     <div class="box top-b options-bar">
                <asp:Button ID="btnBack" runat="server" Text="<%$ Resources:TestSiteResources, HomeAdmin %>" CssClass="green-btn btn fl" PostBackUrl="~/AdminPanel/AdminHome.aspx" />
                <div class="user-nt2">
