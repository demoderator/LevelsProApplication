<%@ Page Title="" Language="C#" MasterPageFile="~/ManagerPanel/Manager.master" AutoEventWireup="true" CodeBehind="Messages.aspx.cs" Inherits="LevelsPro.ManagerPanel.Messages" %>

<%@ Register TagPrefix="uc" TagName="Profile" Src="~/ManagerPanel/UserControls/uc_Profile.ascx" %>
<%@ Register TagPrefix="uc" TagName="MessageDetails" Src="~/ManagerPanel/UserControls/uc_MessageDetails.ascx" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register TagPrefix="uc" TagName="ucComposeMessage" Src="~/ManagerPanel/UserControls/uc_ComposeMessage.ascx" %>
