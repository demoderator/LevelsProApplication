<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_AwardDetails.ascx.cs"
    Inherits="LevelsPro.PlayerPanel.UserControls.uc_AwardDetails" %>
<div class="container">
...
<asp:Button ID="btnClose" CssClass="green" Text="<%$ Resources:TestSiteResources, Close %>" runat="server"
